...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block fixed inset-y-0 left-0 z-50"
      data-state={state}
      data-collapsible={
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear h-full",
      ...
      <div
        ...
        className={cn(
          "absolute inset-y-0 h-screen w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear flex",
          side === "left"
